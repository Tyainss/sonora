...
def _(mo):
    ...
    The next decision is which qualifier patterns represent the same song strongly enough to collapse automatically. The examples above also show where a suffix can change the musical identity enough that we should keep the versions separate or require stronger evidence.
    """)
    return
